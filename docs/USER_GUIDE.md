...
Abaixo do botão **Iniciar recarga**, o totem sempre mostra o preço atual do kWh. Em dois casos ele vem com desconto: de madrugada (0h–6h, incentivo pra achatar o pico de demanda da rede) ou na janela de maior geração solar prevista pro dia (☀, incentivo a usar mais energia limpa) — os dois nunca acontecem ao mesmo tempo.
...
Mais abaixo, o **grid de estações** mostra o status de cada uma das 10 (Livre / Ocupada / Manutenção) e dois gráficos: a **curva de demanda prevista pela IA** nas próximas 24h, e a **curva de geração solar prevista pro dia** (com a janela de desconto destacada).
